 ...
 *
 * This is the most general class for imports. It provides a basic software
 * flow and calls code, that the child classes implement.
 *
...
abstract class AbstractImport implements ImportInterface {
  ...
  /**
   * @var string A SQL-Statement that returns the time of the oldest entry, of
   *   the chosen topic
   */
   ...
   *
   * @var array array from ctrl\TransferSettings like [['export_name' =>
   *   'Field', 'import_name' => 'max(table.field)'], ...]
   */
  public $fields;
   ...
   * @param array $fields Is supposed to be an array of arrays with keys:
   *   import_name and _export_name, like in ctrl\TransferSettings
   */
   ...
   *
   * @param array $fields [ ['export_name'=> 'Draft', 'import_name' =>
   *   'is_draft'], ...]
   *
   */
