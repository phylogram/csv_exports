...
class Time {
  ...
  /**
   * Iterates through time in calender style: Year and month will not be in 365
   * or 30 days, it will be the first day of the next year/month. All other
   * units will behave as absolute values.
   *
   * @param  \DateObject $start
   * @param  \DateObject $stop
   * @param string $frequency Valid units can be found @link
   *   http://php.net/manual/de/datetime.formats.relative.php here. @endlink
   *
   * @return \Generator
   */
