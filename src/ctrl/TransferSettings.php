...
class TransferSettings {
   ...
   * ['name'] => settings
   *
   * This keywords will be read (for more information see the the default
   * values above):
   *
   * - The key of the setting array (eg Donations) will be used to compare with
   * exclude in terminal options
  ...
  public $settings = [
    ...
    'Optin-Contacts' => [
      'class' => '\Drupal\phylogram_datatransfer\import_model\imports\OptInContact',
      'file_name' => 'Optin-Contacts',
      'fields' => [
        // This are Entity properties/keys . %CURRENT% will be replaced, with first entry
        [
          'export_name' => 'Contact ID',
        ...
        [
          'export_name' => 'Optin Statement',
          'import_name' => 'optin_statement',
        ],
      ],
    ],
    ...
    'Optout-Contacts' => [
      'class' => '\Drupal\phylogram_datatransfer\import_model\imports\OptOutContact',
      'file_name' => 'Optin-Contacts',
      'fields' => [
        // This are Entity properties/keys . %CURRENT% will be replaced, with first entry
        [
